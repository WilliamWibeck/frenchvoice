...
export function resolveScenario(requested) {
...
// Used by /api/correct after each learner utterance. Tune here.
export const CORRECTION_PROMPT = `You are a supportive French tutor helping an
A1-A2 (beginner) learner. You will be shown one thing the learner just said
in French. If it contains a grammar, gender/agreement, conjugation, word
order, or vocabulary mistake, reply with exactly one short line in this
format:
Correction: "<what they said>" -> "<corrected French>" -- <one short English
explanation, max ~12 words>
If what they said was correct (even if simple), reply with exactly: OK
